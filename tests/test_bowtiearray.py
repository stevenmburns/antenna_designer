...
def test_bowtiearray_sweep_freq2():
  ant.sweep(bowtiearray.Builder(), 'freq', (28,29), fn='bowtiearray_sweep_freq.pdf')

def test_bowtiearray_sweep_slope_top():
  ant.sweep(bowtiearray.Builder(), 'slope_top', (.2,1), fn='bowtiearray_sweep_slope_top.pdf')

def test_bowtiearray_sweep_slope_bot():
  ant.sweep(bowtiearray.Builder(), 'slope_bot', (.2,1), fn='bowtiearray_sweep_slope_bot.pdf')

def test_bowtiearray_sweep_length_top():
  ant.sweep(bowtiearray.Builder(), 'length_top', (4,6), fn='bowtiearray_sweep_length_top.pdf')

def test_bowtiearray_sweep_length_bot():
  ant.sweep(bowtiearray.Builder(), 'length_bot', (4,6), fn='bowtiearray_sweep_length_bot.pdf')

def test_bowtiearray_sweep_del_z():
  ant.sweep(bowtiearray.Builder(), 'del_z', (1,3), fn='bowtiearray_sweep_del_z.pdf')

def test_bowtiearray_sweep_del_y():
  ant.sweep(bowtiearray.Builder(), 'del_y', (3.5,6), fn='bowtiearray_sweep_del_y.pdf')

def test_bowtiearray_sweep_base():
  ant.sweep(bowtiearray.Builder(), 'base', (6,8), fn='bowtiearray_sweep_base.pdf')

def test_bowtiearray_sweep_gain_del_z():
  ant.sweep_gain(bowtiearray.Builder(), 'del_z', (1,3), fn='bowtiearray_sweep_gain_del_z.pdf')

def test_bowtiearray_sweep_gain_del_y():
  ant.sweep_gain(bowtiearray.Builder(), 'del_y', (3.5,6), fn='bowtiearray_sweep_gain_del_y.pdf')

def test_bowtiearray_sweep_gain_base():
  ant.sweep_gain(bowtiearray.Builder(), 'base', (6,8), fn='bowtiearray_sweep_gain_base.pdf')
